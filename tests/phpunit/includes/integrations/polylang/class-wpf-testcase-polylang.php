...
if ( file_exists( ABSPATH . '/wp-content/plugins/polylang/polylang.php' ) ) {
	/**
	 * Polylang プラグインとの統合テストのためのテストケースクラス。
	 *
	 * Inspired by Polylang:
	 * https://github.com/polylang/polylang/blob/98fce0273661439e60316ab25ed1b7e3922d946e/tests/phpunit/includes/testcase.php
	 */
