...
if ( file_exists( ABSPATH . '/wp-content/plugins/polylang/polylang.php' ) && class_exists( 'PLL_UnitTestCase' ) ) {
	 ...
	 */
	class TestGetBCFrontIsPostsWithPost extends PLL_UnitTestCase {
		 ...
		 */
		public function test_get_the_breadcrumbs_with_post() {
			$this->init_test();
			...
			$expected = array(
				...
				array(
					'text'  => 'test',
					'link'  => home_url( user_trailingslashit( '/en/category/test' ) ),
					'layer' => 'taxonomy',
				),
			);
			...
			$expected = array(
				...
				array(
					'text'  => 'essai',
					'link'  => home_url( user_trailingslashit( '/fr/category/essai' ) ),
					'layer' => 'taxonomy',
				),
			);
			...
			$expected = array(
				...
				array(
					'text'  => 'prufen',
					'link'  => home_url( user_trailingslashit( '/de/category/prufen' ) ),
					'layer' => 'taxonomy',
				),
			);
