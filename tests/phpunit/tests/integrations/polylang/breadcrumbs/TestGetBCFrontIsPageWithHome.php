...
if ( file_exists( ABSPATH . '/wp-content/plugins/polylang/polylang.php' ) && class_exists( 'PLL_UnitTestCase' ) ) {
	 ...
	 */
	class TestGetBCFrontIsPageWithHome extends PLL_UnitTestCase {
		 ...
		 */
		public function test_get_the_breadcrumbs_with_home() {
			$this->init_test();
			...
			$this->assertQueryTrue( 'is_front_page', 'is_page', 'is_singular', 'is_paged' );
