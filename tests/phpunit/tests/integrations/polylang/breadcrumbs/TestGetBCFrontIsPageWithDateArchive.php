...
if ( file_exists( ABSPATH . '/wp-content/plugins/polylang/polylang.php' ) && class_exists( 'PLL_UnitTestCase' ) ) {
	 ...
	 */
	class TestGetBCFrontIsPageWithDateArchive extends PLL_UnitTestCase {
		...
		public function test_get_the_breadcrumbs_with_year_archive() {
			...
			$this->go_to( home_url( user_trailingslashit( '/en/2012' ) ) );
			...
			$this->go_to( home_url( user_trailingslashit( '/fr/2012' ) ) );
			...
			$this->go_to( home_url( user_trailingslashit( '/de/2012' ) ) );
		 ...
		 *
		 * テスト条件:
		 * - デフォルト言語のスラッグを非表示に設定する。
		 *
		 * @covers ::get_the_breadcrumbs
		 * @preserveGlobalState disabled
		 */
		public function test_get_the_breadcrumbs_with_year_archive_and_hide_default() {
			...
			$expected = array(
				...
				array(
					'text'  => 'posts',
					'link'  => home_url( user_trailingslashit( '/posts' ) ),
					'layer' => 'post_type',
				),
			);
		...
		public function test_get_the_breadcrumbs_with_month_archive() {
			...
			$this->pll_env->curlang = self::$model->get_language( 'en' );
			$this->go_to( home_url( user_trailingslashit( '/en/2012/12' ) ) );
			...
			$expected = array(
				...
				array(
					'text'  => '2012',
					'link'  => home_url( user_trailingslashit( '/en/2012' ) ),
					'layer' => 'date',
				),
			);
			...
			$this->pll_env->curlang = self::$model->get_language( 'fr' );
			$this->go_to( home_url( user_trailingslashit( '/fr/2012/12' ) ) );
			...
			$expected = array(
				...
				array(
					'text'  => '2012',
					'link'  => home_url( user_trailingslashit( '/fr/2012' ) ),
					'layer' => 'date',
				),
			);
			...
			$this->pll_env->curlang = self::$model->get_language( 'de' );
			$this->go_to( home_url( user_trailingslashit( '/de/2012/12' ) ) );
			...
			$expected = array(
				...
				array(
					'text'  => '2012',
					'link'  => home_url( user_trailingslashit( '/de/2012' ) ),
					'layer' => 'date',
				),
			);
		...
		public function test_get_the_breadcrumbs_with_day_archive() {
			...
			$this->pll_env->curlang = self::$model->get_language( 'en' );
			$this->go_to( home_url( user_trailingslashit( '/en/2012/12/12' ) ) );
			...
			$expected = array(
				...
				array(
					'text'  => 'December',
					'link'  => home_url( user_trailingslashit( '/en/2012/12' ) ),
					'layer' => 'date',
				),
			);
			...
			$this->pll_env->curlang = self::$model->get_language( 'fr' );
			$this->go_to( home_url( user_trailingslashit( '/fr/2012/12/12' ) ) );
			...
			$expected = array(
				...
				array(
					'text'  => 'December',
					'link'  => home_url( user_trailingslashit( '/fr/2012/12' ) ),
					'layer' => 'date',
				),
			);
			...
			$this->pll_env->curlang = self::$model->get_language( 'de' );
			$this->go_to( home_url( user_trailingslashit( '/de/2012/12/12' ) ) );
			...
			$expected = array(
				...
				array(
					'text'  => 'December',
					'link'  => home_url( user_trailingslashit( '/de/2012/12' ) ),
					'layer' => 'date',
				),
			);
