 ...
 */
class TestGetBCPostWithPageForPosts extends WPF_UnitTestCase {
	 ...
	 */
	public function test_get_the_breadcrumbs_with_post_and_page_for_posts_and_has_parent_post() {
	 ...
	 * @preserveGlobalState disabled
	 */
	public function test_get_the_breadcrumbs_with_post_and_page_for_posts_and_single_term() {
		$page_id = self::factory()->post->create(
			array(
				'post_type'  => 'page',
				'post_title' => 'Foo',
		...
		$expected = array(
			...
			array(
				'text'  => 'Bar',
				'link'  => home_url( user_trailingslashit( '/category/bar' ) ),
				'layer' => 'taxonomy',
			),
			array(
				'text'  => 'Post title 8',
		...
		$expected = array(
			...
			array(
				'text'  => 'Bar',
				'link'  => home_url( '/?cat=' . get_cat_ID( 'bar' ) ),
				'layer' => 'taxonomy',
			),
			array(
				'text'  => 'Post title 8',
	 ...
	 * @preserveGlobalState disabled
	 */
	public function test_get_the_breadcrumbs_with_post_and_page_for_posts_and_has_parent_term() {
		$cat_id = 0;
		for ( $i = 0; $i < 4; $i ++ ) {
	 ...
	 * @preserveGlobalState disabled
	 */
	public function test_get_the_breadcrumbs_with_post_and_page_for_posts_and_multiple_terms() {
		$page_id = self::factory()->post->create(
			array(
				'post_type'  => 'page',
				'post_title' => 'Foo',
	 ...
	 * @preserveGlobalState disabled
	 */
	public function test_get_the_breadcrumbs_with_post_and_page_for_posts_and_multiple_taxs() {
		$page_id = self::factory()->post->create(
			array(
				'post_type'  => 'page',
				'post_title' => 'Foo',
	 ...
	 * @preserveGlobalState disabled
	 */
	public function test_get_the_breadcrumbs_with_post_and_page_for_posts_and_single_term_and_has_parent_post() {
		$page_id = self::factory()->post->create(
			array(
				'post_type'  => 'page',
				'post_title' => 'Foo',
	 ...
	 * @preserveGlobalState disabled
	 */
	public function test_get_the_breadcrumbs_with_post_and_page_for_posts_and_has_parent_term_and_has_parent_post() {
		$page_id = self::factory()->post->create(
			array(
				'post_type'  => 'page',
				'post_title' => 'Foo',
	 ...
	 * @preserveGlobalState disabled
	 */
	public function test_get_the_breadcrumbs_with_post_and_page_for_posts_and_multiple_terms_and_has_parent_post() {
		$page_id = self::factory()->post->create(
			array(
				'post_type'  => 'page',
				'post_title' => 'Foo',
	 ...
	 * @preserveGlobalState disabled
	 */
	public function test_get_the_breadcrumbs_with_post_and_page_for_posts_and_multiple_taxs_and_has_parent_post() {
		$page_id = self::factory()->post->create(
			array(
				'post_type'  => 'page',
				'post_title' => 'Foo',
